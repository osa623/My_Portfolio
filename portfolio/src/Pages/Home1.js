...
useEffect(()=>{
  ...
  return (
    <main className='relative flex h-auto w-full bg-secondary'>
      <section className='sticky  flex-col h-auto w-full bg-secondary'>
        <Stareffect/>
      ...
      <div className='flex flex-col justify-center items-center w-full h-[65vh] mr-auto overflow-hidden pl-2'>
        ...
        <img className='top-0'src={welcome} alt='' style={{
          width:'500px'
         }} data-aos='zoom-in'/>
